document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function clearError(field) {
      ...
      if (errorId) {
        ...
        if (existing && existing.classList.contains('form-error-message')) {
          existing.remove();
        }
  ...
  function initScrollAnimations() {
    const candidates = document.querySelectorAll(
      '.fade-in, .animate, .' + ANIMATION_CLASS + ', [data-scroll-animate], section > *, .card, .feature, .testimonial, .pricing, .hero-content, .cta'
    );
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '833032e5-ad76-452a-b1e2-81112b629f37',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '833032e5-ad76-452a-b1e2-81112b629f37';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '833032e5-ad76-452a-b1e2-81112b629f37';
